...
/* harmony import */ var imports_loader_define_false_scrollmagic_scrollmagic_uncompressed_plugins_animation_gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imports-loader?define=>false!scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap */ "./node_modules/imports-loader/index.js?define=>false!./node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js");
/* harmony import */ var imports_loader_define_false_scrollmagic_scrollmagic_uncompressed_plugins_animation_gsap__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(imports_loader_define_false_scrollmagic_scrollmagic_uncompressed_plugins_animation_gsap__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var imports_loader_define_false_scrollmagic_scrollmagic_uncompressed_plugins_debug_addIndicators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! imports-loader?define=>false!scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators */ "./node_modules/imports-loader/index.js?define=>false!./node_modules/scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators.js");
/* harmony import */ var imports_loader_define_false_scrollmagic_scrollmagic_uncompressed_plugins_debug_addIndicators__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(imports_loader_define_false_scrollmagic_scrollmagic_uncompressed_plugins_debug_addIndicators__WEBPACK_IMPORTED_MODULE_2__);
...
__webpack_require__(/*! gsap/TimelineMax */ "./node_modules/gsap/TimelineMax.js");

var TweenMax = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
...
__webpack_require__(/*! ./components/common */ "./src/js/components/common.js");

__webpack_require__(/*! ./components/dropdown */ "./src/js/components/dropdown.js");

__webpack_require__(/*! ./components/landing-scroll */ "./src/js/components/landing-scroll.js");

__webpack_require__(/*! ./components/about-image-animation */ "./src/js/components/about-image-animation.js");

__webpack_require__(/*! ./components/sliders */ "./src/js/components/sliders.js");

__webpack_require__(/*! ./components/menu */ "./src/js/components/menu.js");

__webpack_require__(/*! ./components/video */ "./src/js/components/video.js");

__webpack_require__(/*! ./components/small-banner-parallax */ "./src/js/components/small-banner-parallax.js");

__webpack_require__(/*! ./components/login-popup */ "./src/js/components/login-popup.js");

/***/ }),

/***/ "./src/js/components/about-image-animation.js":
/*!****************************************************!*\
  !*** ./src/js/components/about-image-animation.js ***!
  \****************************************************/
/*! no static exports found */
...
document.addEventListener("DOMContentLoaded", function (event) {
  if (!document.querySelectorAll('.index-page .about-content-container').length) {
    return;
  } //Get the parent element, attach mousemove listener


  document.querySelectorAll('.index-page .about-content-container')[0].addEventListener('mousemove', cursorPositionHandler); // document.getElementsByClassName('activities-section')[0].addEventListener('mousemove', cursorPositionHandler);
  ...
  function cursorPositionHandler(ev) {
    ...
    decimalY = ev.clientY / window.innerHeight - 0.5; //Request animation frame
  ...
  function requestTick() {
    ...
    if (!ticking) {
      requestAnimationFrame(updateabout); // requestAnimationFrame(update);
      //Set status
  ...
  function updateabout() {
    //Animate rotations
    TweenLite.to(document.querySelectorAll('.index-page .about-content-container .image-container'), 0.2, {
  ...
  //     //Animate rotations
  //     TweenLite.to(document.getElementsByClassName('bg-hover'), 0.2, {rotationY:-10*decimalX, rotationX:10*decimalY, ease:Power2.easeOut, transformPerspective:500, transformOrigin:"center"});
  //     //Set status
  //     ticking = false;
  // }
...
var ticking = false,
    ...
    decimalY = 0;
document.addEventListener("DOMContentLoaded", function (event) {
  if (!document.querySelectorAll('.activity-slider').length) {
    return;
  } //Get the parent element, attach mousemove listener


  document.querySelectorAll('.activity-slider')[0].addEventListener('mousemove', cursorPositionHandler); // document.getElementsByClassName('activities-section')[0].addEventListener('mousemove', cursorPositionHandler);
  //Declare mousemove handler
  ...
  function updateabout() {
    //Animate rotations
    TweenLite.to(document.querySelectorAll('.activity-slider .slick-current .bg-image-container'), 0.2, {
      rotationY: -1.5 * decimalX,
      rotationX: 1.5 * decimalY,
      ease: Power2.easeOut,
      transformPerspective: 500,
      transformOrigin: "center"
    }); //Set status
...
//   });
// $('.circle-plus ').on('click', function(){
//   $(".faq-container .faq-section .faq-content-p ").slideToggle()
// });
$(function () {
  var $mainMenu = $('.faq-content');
  ...
  $('.faq-content').on('click', function () {
    $(this).next($('.faq-content-p ')).slideToggle();
    $(this).find('.circle-plus').toggleClass('opened');
  });
}); // class Scrooth {
//     constructor({element = window, strength=20, acceleration = 0,deceleration = 0.930}={}) {
...
var $loginScroll = $('.scroll-for-menu');
$loginScroll.click(function () {
  var heo = $(window).height();

  if ($(window).scrollTop() < heo) {
    $(window).scrollTop(heo);
  }
});
...
$(function () {
  var $langdropdown = $('.container');
  var $filerdropdown = $('.filter-container');

  if (!$langdropdown.length || !$filerdropdown) {
    return;
  }

  function open($container) {
    var $body = $container.find('.dropdown-body');
    var $icon = $container.find('.dropdown-header svg');
    $container.addClass('active');
    TweenMax.set($body, {
      height: "auto"
    });
    TweenMax.from($body, 0.3, {
      height: '0',
      overflow: "hidden"
    });
  ...
  function close($container) {
    var $body = $container.find('.dropdown-body');
    var $icon = $container.find('.dropdown-header svg');
    $container.removeClass("active"); // $parent.removeClass('active');
  ...
  $("body").on("click", ".container .lang-container .dropdown-header, .container-fluid .dropdown-header", function (e) {
    e.stopPropagation();
  ...
  $('.container .dropdown-body, .container-fluid .dropdown-body').click(function (e) {
    e.stopPropagation();
  });
  $(".lang-container, .filter-item").on('s:close', function (e) {
    e.stopPropagation();
    close($(this));
  });
  $(document).on("click", function () {
    $(".lang-container, .filter-item").trigger('s:close');
  });
});

/***/ }),

/***/ "./src/js/components/landing-scroll.js":
/*!*********************************************!*\
  !*** ./src/js/components/landing-scroll.js ***!
  \*********************************************/
/*! no exports provided */
...
$(function () {
  var $mainMenu = $('.main-navigation.index');
  ...
  var pin = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
    triggerElement: '.main-navigation.index'
  }).setPin('.main-navigation.index', {
    pushFollowers: false
  }).addTo(controller);
}); // small banner paralax

$(function () {
  var $mainMenu = $('.small-banner');
  ...
  parallaxTl.from('.gradient', 0.6, {
    autoAlpha: 0.4,
    ease: Power0.easeNone
  }, 0.6).from('.small-banner .image-container', 2, {
    y: '-30%',
    ease: Power0.easeNone
  }, 0);
  var paralaxScroll = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
    triggerElement: '.small-banner',
    triggerHook: 0,
    duration: "100%"
...
$(function () {
  var $mainMenu = $('.tours-section');
  var $nottour = $('.tours-section').find('.tours-slider');

  if (!$mainMenu.length || $nottour.length) {
    return;
  }

  var controller = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Controller({});
  var articleCont = $(".tours-section:not('.destination-section')  .content-row:not('.tours-slider') .article-container");
  var parallaxTl = new TimelineMax();
  var parallaxT2 = new TimelineMax();
  parallaxTl.staggerFrom(articleCont, 0.3, {
    autoAlpha: 0,
    y: "15%",
    ease: Power0.easeNone
  }, 0.2); // $('.article-container').each(function() {

  var paralaxScroll = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
    triggerElement: '.tours-section:not(.destination-section) .content-row:not(.tours-slider) .article-container',
    triggerHook: 1,
    reverse: false
  }).setTween(parallaxTl).addTo(controller); // });
}); //about
...
$(function () {
  var $mainMenu = $('.about-section');

  if (!$mainMenu.length || $(window).width() < 768) {
    return;
  }
  ...
  if ($(window).width() > 768) {
    var controller = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Controller({});
    var parallaxTl = new TimelineMax();
    parallaxTl.from('.about-slider-container', 1, {
      y: '15%',
      ease: Power0.easeNone
    }, 0);
    var paralaxScroll = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
...
$(function () {
  var $mainMenu = $('.destination-section');
  ...
  var controller = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Controller({});
  var destCont = $(".destination-section  .content-row .article-container");
  var parallaxT2 = new TimelineMax();
  parallaxT2.staggerFrom(destCont, 0.3, {
    autoAlpha: 0,
    y: "15%",
    ease: Power0.easeNone
  }, 0.2); // $('.article-container').each(function() {

  var paralaxScroll2 = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
    triggerElement: '.destination-section .content-row .article-container',
    triggerHook: 1,
    reverse: false
  }).setTween(parallaxT2).addTo(controller); // });
}); //see on map section animation

$(function () {
  var $mainMenu = $('.see-on-map-container');
  ...
  var controller = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Controller({});
  var parallaxTl = new TimelineMax();
  parallaxTl.from('.see-on-map-container .container-small', 0.4, {
    autoAlpha: 0.9,
    ease: Power0.easeNone
  }, 0.4).from('.see-on-map-container .image-container', 2, {
    y: '-30%',
    ease: Power0.easeNone
  }, 0);
  var slideParallaxScene = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
    triggerElement: '.see-on-map-container',
    triggerHook: 1,
    duration: '100%'
  }).setTween(parallaxTl).addTo(controller);
...
$(function () {
  var $mainMenu = $('#main-header'); // var  topDistance= 0;
  // window.addEventListener('scroll', function (event) {
  //     var topDistance= $(document).pageYOffset;
  // });
  ...
  parallaxTl.from('.gradient', 0.6, {
    autoAlpha: 0.4,
    ease: Power0.easeNone
  }, 0.6); // var tween = new TimelineMax ()
  // .add([
  //     TweenMax.to("#img1", 1,{y:- $(window).scrollTop()*0.1, ease: Linear.easeNone}),
  //     TweenMax.to("#img2", 1,{y:- $(window).scrollTop()*0.3, ease: Linear.easeNone}),
  //     TweenMax.to("#img3", 1,{y:- $(window).scrollTop()*0.5, ease: Linear.easeNone}),
  //     TweenMax.to("#img4", 1,{y:- $(window).scrollTop()*0.8, ease: Linear.easeNone}),
  //     TweenMax.to("#img5", 1,{y:- $(window).scrollTop()*0.8, ease: Linear.easeNone})
  // ])
  // ;
  ...
  var paralaxScroll = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
    ...
    triggerHook: "0",
    duration: "35%"
  }).setTween(parallaxTl).setPin('#main-header', {
    pushFollowers: true
  ...
  var scene = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
    ...
    TweenMax.to("#img1", 0.01, {
      y: -$(window).scrollTop() * 0.15,
      scale: 1.1 - $(window).scrollTop() * 0.0001,
      ease: Linear.easeNone
    }, 0.01);
    TweenMax.to("#img2", 0.01, {
      y: -$(window).scrollTop() * 0.2,
      scale: 1.1 - $(window).scrollTop() * 0.0001,
      ease: Linear.easeNone
    }, 0.01);
    TweenMax.to("#img3", 0.01, {
      y: -$(window).scrollTop() * 0.4,
      scale: 1.1 - $(window).scrollTop() * 0.0001,
      ease: Linear.easeNone
    }, 0.01);
    TweenMax.to("#img4", 0.01, {
      y: -$(window).scrollTop() * 0.6,
      scale: 1.1 - $(window).scrollTop() * 0.0001,
      ease: Linear.easeNone
    }, 0.01);
    TweenMax.to("#img5", 0.01, {
      y: -$(window).scrollTop() * 0.59,
      scale: 1.1 - $(window).scrollTop() * 0.0001,
      ease: Linear.easeNone
    }, 0.01); // if($(window).scrollTop()<300){

    TweenMax.to("#img5", 0.01, {
      x: -30 + $(window).scrollTop() / 15,
      rotation: -20 + $(window).scrollTop() / 25,
      ease: Linear.easeNone
    }, 0.01); // }
  }) // scene end
  .addTo(controller);
...
/***/ "./src/js/components/login-popup.js":
/*!******************************************!*\
  !*** ./src/js/components/login-popup.js ***!
  \******************************************/
/*! no static exports found */
...
$(function () {
  ...
  $loginContainer.find(".sign-up").click(function (e) {
    e.stopPropagation();
    $(".lang-container").trigger('s:close');
    var $mainNavigationContainer = $('.main-navigation .container');
    $mainNavigationContainer.hasClass('open') && $mainNavigationContainer.trigger('s:close');
    open($regContainer);
  });
  $loginContainer.find(".reset-pas").click(function (e) {
    e.stopPropagation();
    $(".lang-container").trigger('s:close');
    var $mainNavigationContainer = $('.main-navigation .container');
    $mainNavigationContainer.hasClass('open') && $mainNavigationContainer.trigger('s:close');
  ...
  $regContainer.click(function (e) {
    e.stopPropagation();
  });
  $(document).on("click", function () {
    if ($regContainer.hasClass('active')) {
      close($regContainer);
    }

    if ($resetContainer.hasClass('active')) {
      close($resetContainer);
    }
  });
});
...
var $burger = $("burger-contaienr svg");
$burger.click(function () {}); // additional filter dropdown

$(function () {
  var $mainNavigation = $('.main-navigation');
  var $burger = $(".burger-container svg");
  ...
  function open($container) {
    var $login = $container.find('> .login-container');
    var $burger = $container.find('.burger-container');
    var $responsive = $container.find('.menu-responsive');
  ...
  function close($container) {
    ...
    tl.set($responsive, {
      ...
      display: "none"
    }); // TweenMax.to($body, 0.3, { height: 0, overflow:"hidden" });
    // TweenMax.to($burger, 0.3, { rotation: '0', transformOrigin: 'center' }, "-=0.3");
  }

  $mainNavigation.find('.container').first().on('s:close', function (e) {
    e.stopPropagation();
    close($(this));
  });
  $("body").on("click", ".burger-container, .close-button", function (e) {
    e.stopPropagation();
    var $parent = $(this).closest(".container");

    if ($parent.hasClass('open')) {
      $parent.trigger('s:close');
    } else {
      open($parent);
  ...
  $(window).resize(function () {
    if ($(window).width() > 992 && $(".main-navigation .container").hasClass('open')) {
      $(".main-navigation .container").trigger('s:close');
    }
  });
  $('.menu-responsive .main-menu').click(function (e) {
    e.stopPropagation();
  });
  $(window).on("click", function () {
    if ($(".main-navigation .container").hasClass('open')) {
      close($(".main-navigation .container"));
    }
  });
});
var mainNavLinks = document.querySelectorAll(".main-navigation.index ul li a.scroll-spy-a");
var mainSections = document.querySelectorAll(".main-section");
var lastId;
var cur = []; // This should probably be throttled.
...
//tours slider
$(function () {
  var $toursCarousel = $('.tours-slider');

  if (!$toursCarousel.length) {
    return;
  }

  $toursCarousel.on('init reInit afterChange', function (event, slick, currentSlide, nextSlide) {
    //currentSlide is undefined on init -- set it to 0 in this case (currentSlide is 0 based)
    if (slick.slideCount <= 3) {
      $(".tour-arrow.left-arrow").css({
        display: "none"
      });
      $(".tour-arrow.right-arrow").css({
        display: "none"
      });
    ...
    slidesToShow: 3,
    adaptiveHeight: true,
    prevArrow: $(".tour-arrow.left-arrow"),
    nextArrow: $(".tour-arrow.right-arrow"),
    responsive: [{
      breakpoint: 1200,
      settings: {
        slidesToShow: 2
...
$(function () {
  var $aboutCarousel = $('.about-slider');

  if (!$aboutCarousel.length) {
    return;
  }

  $aboutCarousel.on('init reInit afterChange', function (event, slick, currentSlide, nextSlide) {
    //currentSlide is undefined on init -- set it to 0 in this case (currentSlide is 0 based)
    if (slick.slideCount <= 1) {
      $(".about-arrow.left-arrow").css({
        display: "none"
      });
      $(".about-arrow.right-arrow").css({
        display: "none"
      });
    } // console.log(slick.slideCount);
    ...
    speed: 300,
    slidesToShow: 1,
    prevArrow: $(".about-arrow.left-arrow"),
    nextArrow: $(".about-arrow.right-arrow")
  });
}); //activitie slider

$(function () {
  var $activitieCarousel = $('.activity-slider');

  if (!$activitieCarousel.length) {
    return;
  }

  $activitieCarousel.slick({
    // autoplay:true,
    autoplaySpeed: 2000,
    dots: false,
    arrows: false,
    ...
    adaptiveHeight: true,
    asNavFor: $('.activities-switch-bar'),
    responsive: [{
      breakpoint: 992,
      settings: {
        dots: true
  ...
  }).on('beforeChange', function (event, slick, currentSlide, nextSlide) {// var routl = new TimelineMax();
    // routl.to('.activity-slider .bg-image-container', 0.5, { css: { width: 0, transformOrigin: "center" } })
    //     .to('.activity-slider .bg-image-container', 0.5, { css: { width: "100%", transformOrigin: "center" } })
    // .to('.routes-footer .image-container', 0.5, { autoAlpha:0 }, '-=1')
    // .to('.routes-footer .image-container', 0.5, {autoAlpha:1}, '-=0.5')
  }); // changeSlide();
  // $activitieCarousel.on('afterChange', changeSlide);

  $('.activities-switch-bar').slick({
    slidesToShow: 5,
    slidesToScroll: 1,
    arrows: false,
    asNavFor: $activitieCarousel,
    dots: false,
    centerMode: false,
    focusOnSelect: true
  });
}); // function changeSlide(){
//     const current = $('.activity-slider .slick-current');
//     var prevImg = current.find('.each-activitie-section .container');
//     // var nextImg = current.next().find('img').attr('src') || current.siblings('[data-slick-index]:first').find('img').attr('src');
//     const btnPrev = $('.each-activitie-section .container');
...
/***/ "./src/js/components/small-banner-parallax.js":
/*!****************************************************!*\
  !*** ./src/js/components/small-banner-parallax.js ***!
  \****************************************************/
/*! no static exports found */
...
// //     }
// // }, false);
// let rotate =document.getElementById("img5").style.transform
// var el = document.getElementById("img5");
...
//             // console.log(i)
//             // console.log("inneer")
//             translate3d = 'translate3d(0, ' + movement + 'px, 0) rotate('+ -movement/6 + 'deg)';
...
$(function () {
  var overl = document.querySelector(".video-overlay");
  var play = document.querySelector('.activity-video');
  var videoImage = document.querySelector('.video-container .image-container img');
  ...
  overl.addEventListener("click", function () {
    ...
    if (play.paused) {
      play.play();
      overl.classList.add("stop");
      videoImage.style.display = "none";
    } else {
      play.pause();
      overl.classList.remove("stop");
    }
  });
});
...
__webpack_require__(/*! C:\Users\sbatkhadze\Documents\bitbucket\adventure-tourism\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\sbatkhadze\Documents\bitbucket\adventure-tourism\src\scss\app.scss */"./src/scss/app.scss");
